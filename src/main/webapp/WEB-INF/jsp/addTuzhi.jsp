...
<div class="contain">
    ...
    <div class="main">
        <form id="form" action="${pageContext.request.contextPath}/tuzhi/addTuzhi.do" enctype="multipart/form-data" method="post">
            <%--类别pojo 图名 图号 地址--%>
            ...
            <div class="form-group has-success">
                ...
                <input type="text" class="form-control" id="tuming" name="tuming" placeholder="请输入图名，可以为空，默认为文件名">
            </div>
            <div class="form-group has-success">
                <label class="control-label" for="tuhao">图号</label>
                <input type="text" class="form-control" id="tuhao" name="tuhao" placeholder="请输入图号">
            </div>
            <div class="form-group has-success">
                <label class="control-label" for="file">图纸</label>
...
<script>
    <c:if test="${not empty sessionScope.addTuzhi_msg}">
    $(function () {
        alert("${sessionScope.addTuzhi_msg}")
    });
    </c:if>


    <% request.getSession().removeAttribute("addTuzhi_msg");%>
</script>
</html>