...
<div class="contain">
    ...
    <div class="main">
        <form action="${pageContext.request.contextPath}/wendang/updateWendang.do" enctype="multipart/form-data" method="post">
            <%--类别pojo 图名 图号 地址--%>
            <div class="form-group has-success">
                ...
                <select class="form-control" name="wendangLeibie" id="wendangLeibie">
                    <c:forEach items="${sessionScope.wendangleibieList}" var="wendangLeibie" varStatus="s">
                        <c:if test="${sessionScope.changeWendang.leibie.leibieId==wendangLeibie.leibieId}">
                            <option value="${wendangLeibie.leibieId}" selected>${wendangLeibie.leibieName}</option>
                        </c:if>
                        <c:if test="${sessionScope.changeWendang.leibie.leibieId!=wendangLeibie.leibieId}">
            ...
            <div class="form-group has-success">
                ...
                <input type="text" class="form-control" id="wendangming" name="wendangming" value="${sessionScope.changeWendang.wendangming}" >
            </div>
