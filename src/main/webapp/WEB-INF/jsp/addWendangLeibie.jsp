...
<div class="contain">
    ...
    <div class="main">
        <form id="form" action="${pageContext.request.contextPath}/wendang/addWendangLeibie.do" enctype="multipart/form-data" method="post">
            <%--类别pojo 图名 图号 地址--%>
            ...
            <div class="form-group has-success">
                <label class="control-label" for="leibieName">类别名称</label>
                <input type="text" class="form-control" id="leibieName" name="leibieName" placeholder="类别名称">
            </div>
