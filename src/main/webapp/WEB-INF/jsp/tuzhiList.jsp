...
<body>
                ...
                <tbody id="form_content">
                    <c:forEach items="${sessionScope.tuzhiList}" var="tuzhi" varStatus="s">
                        <tr>
                            ...
                            <td>${tuzhi.tuming}</td>
                            <td>${tuzhi.tuhao}</td>
                            <td><a class="btn btn-primary" href="${pageContext.request.contextPath}/tuzhi/download.do?id=${tuzhi.id}">下载</a>
                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/tuzhi/displayTuzhi.do?id=${tuzhi.id}">预览</a></td>
                        </tr>
                    </c:forEach>
                </tbody>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            <c:forEach items="${sessionScope.tuzhileibieList}" varStatus="s" var="leibie">
            $("#${leibie.leibieId}").click(function () {
                ...
                function(json){
                    ...
                    $.each(list,function(idx)
                    {
                        var data="<tr>" +
                            ...
                            "<td><a class=\"btn btn-default\" href=\"${pageContext.request.contextPath}/tuzhi/download.do?id="+list[idx].id+"\">下载</a>" +
                            "<a class=\"btn btn-default\" href=\"${pageContext.request.contextPath}/tuzhi/displayTuzhi.do?id="+list[idx].id+"\">预览</a></td>" +
                            "</tr>";
                        form.append(data)
                    });
